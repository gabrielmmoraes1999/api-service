...
CREATE TABLE OAUTH2_AUTHORIZATION (
    ...
    REFRESH_TOKEN_VALUE BLOB SUB_TYPE 1 SEGMENT SIZE 80,
...
-- ALTER TABLE OAUTH2_REGISTERED_CLIENT ALTER COLUMN TOKEN_SETTINGS TYPE VARCHAR(500);
-- ALTER TABLE OAUTH2_AUTHORIZATION ADD REFRESH_TOKEN_VALUE BLOB SUB_TYPE 1 SEGMENT SIZE 80;
-- ALTER TABLE OAUTH2_AUTHORIZATION ADD REFRESH_TOKEN_ISSUED_AT TIMESTAMP;
-- ALTER TABLE OAUTH2_AUTHORIZATION ADD REFRESH_TOKEN_EXPIRES_AT TIMESTAMP;
